package org.example.botucsof3012.buoi2.Uni;
...
public class HibernateConfig {
    ...
    static {
       ...
       conf.addAnnotatedClass(NuocHoa.class); // khai bao model ngay sau khi lam xong model thi ghi vao day, bao nhieu model thi bay nhieu giong
