 ...
 * @author Admin
 */
public class ThongTinCaNhanAdmin extends JPanel {
    ...
    public void giaoDien_ThongTinCaNhan() {
        ...
        cardLayout.show(blueCardPanel, "BLUE_2");
    ...
    public JPanel giaoDien_1_ThongTinCaNhan() {
        ...
        JLabel lbl_MaHV_ta = new JLabel("Mã Admin:");
...
// Sự kiện nút Hủy
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ThongTinCaNhanAdmin ttcnPanel = new ThongTinCaNhanAdmin();
            frame.add(ttcnPanel);
